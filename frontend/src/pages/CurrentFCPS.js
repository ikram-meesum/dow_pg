...
export default function CurrentFCPS() {
  ...
  function getStudent() {
    ...
    fetch("http://" + ip.address + ":3001/fcpspresent")
  ...
  return (
    <div>
      ...
      >
        <h2>Current FCPS-II Trainees</h2>
        ...
        <Link className="btn btn-primary mb-4" to={"/addfcps"}>
          Add New Student
        </Link>

        <div className="alert alert-info text-center p-2" role="alert">
          All FCPS-II Current Trainees Records.
        </div>
